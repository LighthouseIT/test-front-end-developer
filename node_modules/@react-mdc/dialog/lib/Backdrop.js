...
exports.CLASS_NAME = constants_1.BASE_CLASS_NAME + "__backdrop";
/**
 * Backdrop component
 */
...
var Backdrop = (function (_super) {
    ...
    Backdrop.prototype.getMetaComponent = function () {
        return Meta;
    };
    Backdrop.prototype.getMetaPropNames = function () {
        return [
            "className",
        ];
    };
    Backdrop.prototype.getChildComponent = function () {
        return "div";
    };
    Backdrop.Meta = Meta;
    return Backdrop;
