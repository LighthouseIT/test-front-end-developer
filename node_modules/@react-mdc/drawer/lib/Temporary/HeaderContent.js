...
exports.CLASS_NAME = constants_1.BASE_CLASS_NAME + "__header-content";
...
exports.Meta = Meta;
var HeaderContent = (function (_super) {
    __extends(HeaderContent, _super);
    function HeaderContent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HeaderContent.prototype.getMetaComponent = function () {
        return Meta;
    };
    HeaderContent.prototype.getMetaPropNames = function () {
        return [
            "className",
        ];
    };
    HeaderContent.prototype.getChildComponent = function () {
        return "div";
    };
